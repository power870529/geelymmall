...
public class OrderSerivceImpl implements IOrderService {
    ...
    public ServerResponse cancle(Integer userId, Long orderNo) {
        ...
        updateOrder.setStatus(Const.OrderStatusEnum.CANCLEED.getCode());
    ...
    public ServerResponse getOrderList(Integer userId, int pageNum, int pageSize) {
        ...
        if (CollectionUtils.isEmpty(orderList)) {
            return ServerResponse.createByError("没有订单");
        }
    ...
    public ServerResponse pay(Long orderNo, Integer userId, String path) {
        Map<String, String> resulMap = Maps.newHashMap();
        Order order = orderMapper.selectByUserIdAndOrderNo(orderNo, userId);
        if (order == null) {
            return ServerResponse.createByError("用户没有该订单");
        }
        resulMap.put("orderNo", String.valueOf(order.getOrderNo()));
        ...
        String subject = new StringBuilder("geelymmall扫码支付，订单号:").append(outTradeNo).toString();
        ...
        switch (result.getTradeStatus()) {
            case SUCCESS:
                ...
                resulMap.put("qrUrl", qrUrl);
                return ServerResponse.createBySuccess(resulMap);
    ...
    public ServerResponse aliCallback(Map<String, String> params) {
        ...
        if (order == null) {
            return ServerResponse.createByError("非商城订单，回调忽略");
        }
        ...
        PayInfo payInfo = PayInfo.builder().userId(order.getUserId()).orderNo(orderNo)
                .payPlatform(Const.PayPlatformEnum.ALIPAY.getCode()).platformNumber(tradeNo)
